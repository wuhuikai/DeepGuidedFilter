...
from module import DeepGuidedFilterDJF

default_config.NAME = 'HR_AD_DJF_FT'
default_config.N_EPOCH = 30
default_config.DATA_SET = 'random'

# model
default_config.model = DeepGuidedFilterDJF()
...
default_config.exceed_limit = lambda size: size[0]*size[1] > 1536**2
