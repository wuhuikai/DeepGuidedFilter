...
$TF_BASE/bazel-bin/tensorflow/tools/graph_transforms/transform_graph \
  ...
  --inputs='lowres_input,fullres_input' \
  --outputs='output_coefficients,inference/multiscale/ds0/Relu,inference/multiscale/ds1/Relu,inference/multiscale/ds2/Relu,inference/guide/level_0/Squeeze,inference/guide/level_1/Squeeze,inference/guide/level_2/Squeeze' \
